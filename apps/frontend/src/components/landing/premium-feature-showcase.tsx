  ...
  return (
    <section className="grid gap-4 lg:grid-cols-2">
      {features.map((feature, index) => (
        ...
        >
          <p className="inline-flex rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.24em] text-blue-700 dark:border-blue-500/40 dark:bg-blue-500/20 dark:text-blue-300">
            Premium Capability
          </p>
