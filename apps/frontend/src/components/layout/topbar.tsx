  ...
  return (
    ...
    >
      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        <Link href="/tools" className="glass rounded-full border border-border px-4 py-2 text-xs uppercase tracking-[0.2em] text-secondary hover:border-accent hover:text-accent">
          <span aria-hidden="true">⌘</span> Open Tools
        </Link>
        <Link href="/editor" className="rounded-full bg-accent px-4 py-2 text-xs uppercase tracking-[0.2em] text-white hover:bg-accent-hover">
